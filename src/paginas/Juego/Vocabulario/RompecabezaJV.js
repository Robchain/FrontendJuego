...
const RompecabezaJV = () => {
  ...
  const {data,
     ...
     rompecabeza4,
     rompecabeza5,
     rompecabeza6, setavance,setData} = useContext(JuecoContext);
...
const Modalaqui = ({url,descripcion, modal,clickHandle, setModal })=>{
 ...
 const impresion=()=>{
  ...
  document.querySelector(".a").classList.remove("desaparecer");
    ...
    return (
    <div>
      <Modal isOpen={modal} toggle={toggle} backdrop={false} size="lg" fullscreen="sm">
