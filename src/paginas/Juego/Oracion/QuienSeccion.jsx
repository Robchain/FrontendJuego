...
const QuienSeccion = () => {
  ...
  const RespuestaImagen =({oraciondata})=>{
   ...
   const VerCantidad = ()=>{
    let verbo = "";
    if (oraciondata.Juego1.Partida.Juego1.Oraciones.Oracion1.Respuesta === "CORRECTO") {
      verbo = oraciondata.Juego1.Partida.Juego1.Oraciones.Oracion1.Adverbio
    } else if (oraciondata.Juego1.Partida.Juego1.Oraciones.Oracion2.Respuesta === "CORRECTO") {
      verbo = oraciondata.Juego1.Partida.Juego1.Oraciones.Oracion2.Adverbio
    } else if (oraciondata.Juego1.Partida.Juego1.Oraciones.Oracion3.Respuesta === "CORRECTO") {
      verbo = oraciondata.Juego1.Partida.Juego1.Oraciones.Oracion3.Adverbio
    }
    return (<h3>{verbo}</h3>)
       }
       const VerSeleccionQuien = ()=>{
        let verbo = "";
        if (oraciondata.Juego1.Partida.Juego1.Oraciones.Oracion1.Respuesta === "CORRECTO") {
          verbo = oraciondata.Juego1.Partida.Juego1.Oraciones.Oracion1.FileSujetoImagen
        } else if (oraciondata.Juego1.Partida.Juego1.Oraciones.Oracion2.Respuesta === "CORRECTO") {
          verbo = oraciondata.Juego1.Partida.Juego1.Oraciones.Oracion2.FileSujetoImagen
        } else if (oraciondata.Juego1.Partida.Juego1.Oraciones.Oracion3.Respuesta === "CORRECTO") {
          verbo = oraciondata.Juego1.Partida.Juego1.Oraciones.Oracion3.FileSujetoImagen
        }
  ...
  return (
    <>
      ...
      {
                  momento === "inicial" && <Preguntasecction />
      }
      {
              momento ==="Respuesta" && <Respuestasecction />
      }
              </Col>
              <Col  lg="8">
