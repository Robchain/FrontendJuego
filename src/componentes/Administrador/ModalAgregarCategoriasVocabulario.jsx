...
export const ModalAgregarCategoriasVocabulario = ({modal, toggle}) => {
  ...
  const subidaData = async () =>{
    try {
const data  = await  CrearPostCategoria({Juego:{value:'Vocabulario'},NombreCategoria});
  MySwal.fire({
    title: `${data.titulo}`,
    text: `${data.respuesta}`,
    icon: `${data.type}`,
  ...
  return (
    ...
    <ModalHeader style={{backgroundColor:'#e6dff0', color:"#592a98"}}>Agregar Categoría Vocabulario</ModalHeader>
    <ModalBody>
     <Row><Col>
