  ...
  return (
    <Modal isOpen={modal} toggle={toggle} keyboard={false} aria-hidden={true} backdrop={'static'} className='modal-dialog-centered'>
      ...
      <ModalBody>
        <Row>
        <Col>
          <Label for='Curso' style={{ color: '#8b8b8c', fontWeight: "700" }}>Tipo de juego</Label>
          ...
          <Label for='Curso' style={{ color: '#8b8b8c', fontWeight: "700" }}>Fechas</Label>
          <Input name='Curso' placeholder='Curso' onChange={event => dispatch( { type: "onchange", field: "Curso", value: event.target.value.toUpperCase()})} defaultValue={Curso}  value={Curso} />
        </Col>
        </Row>
      </ModalBody>
      <ModalFooter>
        ...
        <Button onClick={''} disabled={bloqueo} style={{ borderRadius: "10px", backgroundColor: "#62259E", color: "#fff", borderColor: "#62259E" }}>
          Editar
        </Button>
      </ModalFooter>
    </Modal>
