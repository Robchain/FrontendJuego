...
const Preguntasecction = ({ id, window, data }) => {
  ...
  const SeleccionQue = ({ data, QueSelecion, id, window }) => {
    if (QueSelecion === 1) { return (<img src={data.Juegos[id][`Juego${window.id}`].Oraciones.Oracion1.FileAdjetivoImagen} width="170" alt='opcion1' />) }
    if (QueSelecion === 2) { return (<img src={data.Juegos[id][`Juego${window.id}`].Oraciones.Oracion2.FileAdjetivoImagen} width="170" alt='opcion2' />) }
    if (QueSelecion === 3) { return (<img src={data.Juegos[id][`Juego${window.id}`].Oraciones.Oracion3.FileAdjetivoImagen} width="170" alt='opcion3' />) }
    if (QueSelecion === 0) { return (<></>) }
    return (<></>)
  }
  
  const SeleccionCantidad = ({ AdverbNSeleccion, id, window, data }) => {
    if (AdverbNSeleccion === 1) { return (<h3 style={{ color: "blue" }}>{data.Juegos[id][`Juego${window.id}`].Oraciones.Oracion1.Adverbio}</h3>) }
    if (AdverbNSeleccion === 2) { return (<h3 style={{ color: "blue" }}>{data.Juegos[id][`Juego${window.id}`].Oraciones.Oracion2.Adverbio}</h3>) }
    if (AdverbNSeleccion === 3) { return (<h3 style={{ color: "blue" }}>{data.Juegos[id][`Juego${window.id}`].Oraciones.Oracion3.Adverbio}</h3>) }
    if (AdverbNSeleccion === 0) { return (<></>) }
    return (<></>)
  }
  const SeleccionQuien = ({ QuienSeleccion, id, window, data }) => {
    if (QuienSeleccion === 1) { return (<img src={data.Juegos[id][`Juego${window.id}`].Oraciones.Oracion1.FileSujetoImagen} width="170" alt='opcion1' />) }
    if (QuienSeleccion === 2) { return (<img src={data.Juegos[id][`Juego${window.id}`].Oraciones.Oracion2.FileSujetoImagen} width="170" alt='opcion2' />) }
    if (QuienSeleccion === 3) { return (<img src={data.Juegos[id][`Juego${window.id}`].Oraciones.Oracion3.FileSujetoImagen} width="170" alt='opcion3' />) }
          ...
          && (
            <Row lg="12" className='align-items-center'>
              ...
              <Col style={{ width: "150px", height: "100px", pointerEvents: estate.pointer3, opacity: opacarAdverbio.opacity1 }} onClick={onhandleClickAdvePrimero}>
                <span style={{ color: "blue" }}>{data.Juegos[id][`Juego${window.id}`].Oraciones.Oracion1.Adverbio}</span>
              </Col>
              <Col style={{ width: "150px", height: "100px", pointerEvents: estate.pointer3, opacity: opacarAdverbio.opacity2 }} onClick={onhandleClickAdveSegundo} >
                <span style={{ color: "blue" }}>{data.Juegos[id][`Juego${window.id}`].Oraciones.Oracion2.Adverbio}</span>
              </Col>
              <Col style={{ width: "150px", height: "100px", pointerEvents: estate.pointer3, opacity: opacarAdverbio.opacity3 }} onClick={onhandleClickAdveTercero} >
                <span style={{ color: "blue" }}>{data.Juegos[id][`Juego${window.id}`].Oraciones.Oracion3.Adverbio}</span>
              </Col>
            </Row>)
        }
        <Row lg="12" className='align-items-center'>
          ...
          <Col style={{ width: "175px", pointerEvents: estate.pointer2, opacity: opacarQue.opacityQue1 }} onClick={() => { onhandleClickQuePrimero() }}>
            <img src={data.Juegos[id][`Juego${window.id}`].Oraciones.Oracion1.FileAdjetivoImagen} width="170" alt='opcion1' />
          </Col>
          <Col style={{ width: "175px", pointerEvents: estate.pointer2, opacity: opacarQue.opacityQue2 }} onClick={() => { onhandleClickQueSegundo() }}>
            <img src={data.Juegos[id][`Juego${window.id}`].Oraciones.Oracion2.FileAdjetivoImagen} width="170" alt='opcion2' />
          </Col>
          <Col style={{ width: "175px", pointerEvents: estate.pointer2, opacity: opacarQue.opacityQue3 }} onClick={() => { onhandleClickQueTercero() }}>
            <img src={data.Juegos[id][`Juego${window.id}`].Oraciones.Oracion3.FileAdjetivoImagen} width="170" alt='opcion3' />
          </Col>
        </Row>
      </Col>
      <Col lg="8">
